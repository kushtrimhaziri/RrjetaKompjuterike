...
while v:
    ...
    serverPort = 1
    print(
        "Shtyp 1 per te vazhduar me vlera default, shtyp 2 per tí shkruar vlerat manualisht, shtyp 0 per ta ndalur "
        "programin: ")
            ...
            if len(var) > 128:
                ...
                try:
                    if request[0] == 'ipaddress':
                        ...
                        if (len(request) == 1):
                            print(
                                "Metoda COUNT duhet te kete me shume se nje parameter")
                            continue
                        else:
                            s.send(str.encode(var))
                        ...
                        if (len(request) == 1):
                            print(
                                "Metoda REVERSE duhet te kete me shume se nje parameter")
                            continue
                        else:
                            s.send(str.encode(var))
                        ...
                        if (len(request) == 3):
                            ...
                            print(
                                "Metoda GCF duhet te kete 3 argumente")
                            continue
